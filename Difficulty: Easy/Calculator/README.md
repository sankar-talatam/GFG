<h2><a href="https://www.geeksforgeeks.org/problems/calculator--172632/1?page=1&category=Java,Java-Collections,OOP,Java-Strings,Java-Class%20and%20Object,Java-Control-Flow,Java-Operators&status=unsolved,attempted&sortBy=submissions">Calculator</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given two numbers&nbsp;<strong>a</strong>&nbsp;and&nbsp;<strong>b</strong>. You need to perform basic mathematical operations on them. You will be provided an integer named as <strong>operator. </strong></span></p>
<ul>
